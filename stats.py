...
print("Wszystkich pozycji postojowych(stop_position) w bazie osm    :" + str(osm_pos+osm_pos_ref))
print("                                                       z tego:" + str(osm_pos_ref) + " z REFem")
print("Wszystkich platform w bazie osm                              :" + str(osm_plat+osm_plat_ref))
print("                                                       z tego:" + str(osm_plat_ref) + " z REFem")
